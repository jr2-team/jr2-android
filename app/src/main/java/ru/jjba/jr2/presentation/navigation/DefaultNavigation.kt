...
import ru.jjba.jr2.presentation.navigation.command.StartFlow
import ru.jjba.jr2.presentation.navigation.item.Screen
...
abstract class DefaultNavigator(
    ...
    override fun setupFragmentTransactionAnimation(
        ...
        when (command) {
            ...
            is Replace ->
                if (command.screenKey != Screen.AUTH.title) // костылик
                    fragmentTransaction.setCustomAnimations(
                            R.animator.slide_in_left,
                            R.animator.slide_out_right,
                            R.animator.slide_in_left,
